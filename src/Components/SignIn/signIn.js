            ...
            <main id='Sign in Form' className="pa4 black-80">
                <div className="measure">
                    ...
                    <div className="mt3">
                        ...
                        <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-100" type="email" name="email-address"  id="email-address" onKeyUpCapture={this.onEmailChange}/>
                    </div>
                    <div className="mv3">
                    ...
                    <p href="#0" className="f6 link dim black db pointer" onClick={() => onRouteChange('register')}>Sign up</p>
                    </div>
                </div>
            </main>
        </article>
